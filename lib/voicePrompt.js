...
Structure: one closing paragraph only, and it gives the reader a check to run on their own situation or a question to ask a brand - never a second paragraph that attacks other brands or restates the point a different way.

Closing: always ends with a concrete "ask" - a question the reader should put to any brand - never a "buy" call to action. Her own product, if mentioned, appears last and briefly, as a disclosure, and only using facts already established.`;
