...
Rhythm: median sentence around 14 words. A long explanatory sentence (often carrying a list) is followed by one to three short, complete clauses that land the point. Never stack more than three short sentences in a row. This is a hard structural requirement, not a stylistic nudge: at least 15% of all sentences in the post must be 8 words or fewer - in a 400-550 word post that's roughly 4-6 short landing sentences, not zero and not one. Write these as complete sentences with a subject and a verb (e.g. "That's the entire problem." / "It is also not helpful." / "The problem is almost never the formulation."), placed right after the long sentence they're landing, spread across multiple paragraphs, not bunched in one place.
